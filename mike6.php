...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO Spartans (gamertag, nivel, nombre_personaje, 
                        bando, id_rango, id_faccion, id_identificador, 
...
<style>
        ...
        .form-container input[type="submit"] {
            background-color:rgb(63, 100, 70);
            border: none;
            color: white;
            font-weight: bold;
            cursor: pointer;
        ...
        table th {
            background-color:rgb(145, 255, 150)
        }
    </style>
      ...
      <li class="nav-item dropdown">
        ...
        aria-haspopup="true" aria-expanded="false" style="color: black;">
         ...
         <li><a href="movie.html">Peliculas API</a></li>
              <li><a href="dragonb.html">Dragon Ball API</a></li>
              <li><a href="hrptt.html">Pagina Final API</a></li>
          <a class="dropdown-item" href="mike03.html">practica diez</a><br>
         </div>
      </li>
    </ul>
    </div>
...
<p style="text-align: center; color: black; font-family: 'Jomolhari', sans-serif;">Rondan Romero</p>
        <p class="lead">
        </p>
      </div>
</nav>
